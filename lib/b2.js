...
B2.prototype.createBucket = function(bucketName, bucketType, bucketInfo) {
    return actions.bucket.create(this, bucketName, bucketType, bucketInfo);
};
...
B2.prototype.updateBucket = function(bucketId, bucketType, bucketInfo) {
    return actions.bucket.update(this, bucketId, bucketType, bucketInfo);
};
...
// - destinationBucketId
// - fileName
B2.prototype.copyFile = function(args) {
    return actions.file.copyFile(this, args);
};
