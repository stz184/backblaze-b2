...
exports.copyFile = function (b2, args) {
    const sourceFileId = args.sourceFileId;
    const destinationBucketId = args.destinationBucketId;
    const fileName = args.fileName;
    const options = {
        url: endpoints(b2).copyFileUrl,
        method: 'POST',
        headers: utils.getAuthHeaderObjectWithToken(b2),
        data: {
            sourceFileId,
